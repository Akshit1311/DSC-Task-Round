  ...
  return (
    <div className="footer">
      <div className="footer__details">
        ...
        <div className="footer__details__title">About</div>
        <div className="footer__details__title">Help</div>
        <div className="footer__details__title">Social Media</div>
      </div>
      ...
      <div className="footer__details">
        <div className="footer__details__item">
          ...
          <div>info@warehouse.project 1-232-3434 (Main)</div>
        </div>
        <div className="footer__details__item">
          <div>Profile</div>
          <div>Features</div>
        ...
        <div className="footer__details__item">
          <div className="footer__details__sm">
            <svg
              width="50"
              height="50"
              viewBox="0 0 50 50"
      ...
      <div className="footer__cr">
        <div className="footer__cr__left">
